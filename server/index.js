...
app.post('/api/coral/search', async (req, res) => {
  return res.status(200).json({
    results: [
      {
        id: 'doc1',
        title: 'Gen Z Millennial Survey',
        text: 'const surveyText = "Deloitte.\nLiving and working with purpose in a transforming world\n\nMarking its 13th annual edition, Deloitte’s 2024 Gen Z and Millennial Survey connected with\nmore than 22,800 respondents in 44 countries to explore their attitudes about work and the\nworld around them.\n\nAs around half of the world’s population heads to the polls this year1, including in 23 of\nthe 44 markets covered in this survey, the year seems to represent one of potential global\nchange and opportunity. While the role and significance of upcoming elections this year\nvaries across countries, for many markets the results of the elections promise to have a\nsignificant impact on the issues that matter most to Gen Zs and millennials around the\nworld, and respondents’ outlook for the social and political situations in their countries\nreflects that ambiguity. But in many ways, this year’s survey findings reveal that Gen Zs and\nmillennials see green shoots of optimism for the year ahead.\nMany believe that the economic picture in their countries will improve over the next year,\nand that this will have a positive impact on their own personal finances. And, despite\nconcerns seen in last year’s survey that employers might backtrack on workplace progress\nas they faced economic uncertainty, this year’s findings reveal that respondents feel their\nemployers have continued to make incremental progress since the start of the COVID-19\npandemic in areas such as work/life balance; flexibility at work; societal impact; diversity,\nequity, and inclusion (DEI); and protecting the environment.2\nHowever, respondents continue to express significant concerns about the future. The cost of\nliving is once again their top concern this year, followed by unemployment, climate change,\nmental health, and crime/personal safety. There is uncertainty about how Generative AI\n(GenAI) could impact work and their own careers. And they believe business is still falling\nshort of its potential to address some of the world’s most critical societal challenges from\nprotecting the environment, to social inequality.";',
        url: 'https://www.deloitte.com/content/dam/assets-shared/docs/campaigns/2024/deloitte-2024-genz-millennial-survey.pdf?dlva=1',
